...
import static com.immrhy.learningandroidapptool.fermata.BuildConfig.VERSION_CODE;
import static com.immrhy.learningandroidapptool.fermata.BuildConfig.VERSION_NAME;
import static com.immrhy.learningandroidapptool.utils.collection.CollectionUtils.newLinkedHashSet;
import static com.immrhy.learningandroidapptool.utils.ui.UiUtils.isVisible;
import static com.immrhy.learningandroidapptool.utils.ui.UiUtils.showInfo;
import static com.immrhy.learningandroidapptool.utils.ui.view.NavBarItem.create;
import static com.immrhy.learningandroidapptool.utils.ui.view.NavBarView.POSITION_LEFT;
import static com.immrhy.learningandroidapptool.utils.ui.view.NavBarView.POSITION_RIGHT;
...
import com.immrhy.learningandroidapptool.fermata.ui.view.MediaItemListView;
...
import com.immrhy.learningandroidapptool.utils.holder.IntHolder;
...
import com.immrhy.learningandroidapptool.utils.ui.fragment.GenericFragment;
...
import com.immrhy.learningandroidapptool.utils.ui.view.NavBarItem;
import com.immrhy.learningandroidapptool.utils.ui.view.NavBarView;
import com.immrhy.learningandroidapptool.utils.ui.view.NavButtonView;
import com.immrhy.learningandroidapptool.utils.ui.view.PrefNavBarMediator;
...
public class NavBarMediator extends PrefNavBarMediator
	...
	protected Collection<NavBarItem> getItems(NavBarView nb) {
		...
		for (String name : names) {
			switch (name) {
				case "folders":
					items.add(
							create(ctx, R.id.folders_fragment, com.immrhy.learningandroidapptool.utils.R.drawable.folder, R.string.folders,
									items.size() < max));
					continue;
				case "favorites":
					items.add(
				...
				case "playlists":
					...
					continue;
				case "menu":
					items.add(create(ctx, R.id.menu, com.immrhy.learningandroidapptool.utils.R.drawable.menu, R.string.menu,
							items.size() < max));
					continue;
			}
	...
	public boolean menuItemSelected(OverlayMenuItem item) {
		...
		if (itemId == R.id.nav_got_to_current) {
			...
			if (!(a.showFragment(com.immrhy.learningandroidapptool.utils.R.id.generic_fragment) instanceof GenericFragment f))
				return false;
