...
public class FermataMediaService extends MediaBrowserServiceCompat {
	public static final String ACTION_MEDIA_SERVICE = "com.immrhy.learningandroidapptool.fermata.action.MediaService";
	public static final String INTENT_ATTR_NOTIF_COLOR = "com.immrhy.learningandroidapptool.fermata.notif.color";
	...
	private static final String INTENT_PREV = "com.immrhy.learningandroidapptool.fermata.action.prev";
	private static final String INTENT_RW = "com.immrhy.learningandroidapptool.fermata.action.rw";
	private static final String INTENT_STOP = "com.immrhy.learningandroidapptool.fermata.action.stop";
	private static final String INTENT_PLAY = "com.immrhy.learningandroidapptool.fermata.action.play";
	private static final String INTENT_PAUSE = "com.immrhy.learningandroidapptool.fermata.action.pause";
	private static final String INTENT_FF = "com.immrhy.learningandroidapptool.fermata.action.ff";
	private static final String INTENT_NEXT = "com.immrhy.learningandroidapptool.fermata.action.next";
	private static final String INTENT_FAVORITE_ADD = "com.immrhy.learningandroidapptool.fermata.action.favorite.add";
	private static final String INTENT_FAVORITE_REMOVE = "com.immrhy.learningandroidapptool.fermata.action.favorite.remove";
	...
	public void notificationInit() {
		...
		try {
			Intent i = new Intent(this, Class.forName("com.immrhy.learningandroidapptool.fermata.ui.activity.MainActivity"));
			notifContentIntent =
