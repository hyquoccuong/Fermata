...
import static com.immrhy.learningandroidapptool.fermata.action.KeyEventHandler.handleKeyEvent;
import static com.immrhy.learningandroidapptool.fermata.media.engine.MediaEngine.NO_SUBTITLES;
import static com.immrhy.learningandroidapptool.fermata.media.pref.MediaPrefs.AE_ENABLED;
import static com.immrhy.learningandroidapptool.fermata.media.pref.MediaPrefs.BASS_ENABLED;
import static com.immrhy.learningandroidapptool.fermata.media.pref.MediaPrefs.BASS_STRENGTH;
import static com.immrhy.learningandroidapptool.fermata.media.pref.MediaPrefs.EQ_BANDS;
import static com.immrhy.learningandroidapptool.fermata.media.pref.MediaPrefs.EQ_ENABLED;
import static com.immrhy.learningandroidapptool.fermata.media.pref.MediaPrefs.EQ_PRESET;
import static com.immrhy.learningandroidapptool.fermata.media.pref.MediaPrefs.EQ_USER_PRESETS;
import static com.immrhy.learningandroidapptool.fermata.media.pref.MediaPrefs.VIRT_ENABLED;
import static com.immrhy.learningandroidapptool.fermata.media.pref.MediaPrefs.VIRT_MODE;
import static com.immrhy.learningandroidapptool.fermata.media.pref.MediaPrefs.VIRT_STRENGTH;
import static com.immrhy.learningandroidapptool.fermata.media.pref.MediaPrefs.VOL_BOOST_ENABLED;
import static com.immrhy.learningandroidapptool.fermata.media.pref.MediaPrefs.VOL_BOOST_STRENGTH;
import static com.immrhy.learningandroidapptool.fermata.media.pref.MediaPrefs.getUserPresetBands;
import static com.immrhy.learningandroidapptool.fermata.media.pref.PlaybackControlPrefs.getTimeMillis;
...
import static com.immrhy.learningandroidapptool.utils.function.CheckedRunnable.runWithRetry;
import static com.immrhy.learningandroidapptool.utils.misc.Assert.assertNotNull;
import static com.immrhy.learningandroidapptool.utils.misc.MiscUtils.ifNotNull;
...
import com.immrhy.learningandroidapptool.fermata.media.engine.AudioEffects;
import com.immrhy.learningandroidapptool.fermata.media.engine.MediaEngine;
import com.immrhy.learningandroidapptool.fermata.media.engine.MediaEngineManager;
import com.immrhy.learningandroidapptool.fermata.media.engine.MediaEngineProvider;
import com.immrhy.learningandroidapptool.fermata.media.engine.SubtitleStreamInfo;
...
import com.immrhy.learningandroidapptool.fermata.media.lib.MediaLib.StreamItem;
import com.immrhy.learningandroidapptool.fermata.media.pref.BrowsableItemPrefs;
import com.immrhy.learningandroidapptool.fermata.media.pref.MediaLibPrefs;
import com.immrhy.learningandroidapptool.fermata.media.pref.MediaPrefs;
import com.immrhy.learningandroidapptool.fermata.media.pref.PlayableItemPrefs;
import com.immrhy.learningandroidapptool.fermata.media.pref.PlaybackControlPrefs;
import com.immrhy.learningandroidapptool.fermata.media.sub.SubGrid;
import com.immrhy.learningandroidapptool.fermata.media.sub.Subtitles;
import com.immrhy.learningandroidapptool.fermata.ui.view.VideoView;
...
import com.immrhy.learningandroidapptool.utils.event.EventBroadcaster;
import com.immrhy.learningandroidapptool.utils.function.BiConsumer;
...
import com.immrhy.learningandroidapptool.utils.net.NetServer;
...
public class MediaSessionCallback extends MediaSessionCompat.Callback
	...
	public static final String EXTRA_POS = "com.immrhy.learningandroidapptool.fermata.extra.pos";
	private static final String CUSTOM_ACTION_RW = "com.immrhy.learningandroidapptool.fermata.action.rewind";
	private static final String CUSTOM_ACTION_FF = "com.immrhy.learningandroidapptool.fermata.action.fastForward";
	private static final String CUSTOM_ACTION_REPEAT_ENABLE = "com.immrhy.learningandroidapptool.fermata.action.repeat.enable";
	private static final String CUSTOM_ACTION_REPEAT_DISABLE =
			"com.immrhy.learningandroidapptool.fermata.action.repeat" + ".disable";
	private static final String CUSTOM_ACTION_SHUFFLE_ENABLE =
			"com.immrhy.learningandroidapptool.fermata.action.shuffle" + ".enable";
	private static final String CUSTOM_ACTION_SHUFFLE_DISABLE =
			"com.immrhy.learningandroidapptool.fermata.action.shuffle.disable";
	private static final String CUSTOM_ACTION_FAVORITES_ADD = "com.immrhy.learningandroidapptool.fermata.action.favorites.add";
	private static final String CUSTOM_ACTION_FAVORITES_REMOVE =
			"com.immrhy.learningandroidapptool.fermata.action.favorites.remove";
