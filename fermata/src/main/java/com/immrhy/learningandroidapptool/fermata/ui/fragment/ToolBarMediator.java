...
import static com.immrhy.learningandroidapptool.fermata.media.pref.BrowsableItemPrefs.SORT_BY_DATE;
import static com.immrhy.learningandroidapptool.fermata.media.pref.BrowsableItemPrefs.SORT_BY_FILE_NAME;
import static com.immrhy.learningandroidapptool.fermata.media.pref.BrowsableItemPrefs.SORT_BY_NAME;
import static com.immrhy.learningandroidapptool.fermata.media.pref.BrowsableItemPrefs.SORT_BY_NONE;
import static com.immrhy.learningandroidapptool.fermata.media.pref.BrowsableItemPrefs.SORT_BY_RND;
import static com.immrhy.learningandroidapptool.utils.ui.UiUtils.isVisible;
import static com.immrhy.learningandroidapptool.utils.ui.activity.ActivityListener.FRAGMENT_CHANGED;
...
import com.immrhy.learningandroidapptool.utils.ui.view.ImageButton;
...
public class ToolBarMediator implements ToolBarView.Mediator.BackTitleFilter {
	...
	public void enable(ToolBarView tb, ActivityFragment f) {
		...
		if ((f instanceof MediaLibFragment) && a.getPrefs().getShowPgUpDownPref(a)) {
			...
			tb.findViewById(com.immrhy.learningandroidapptool.utils.R.id.tool_bar_back_button);
		}
	...
	public View focusSearch(ToolBarView tb, View focused, int direction) {
		...
		if (direction == FOCUS_UP) {
			...
			Context ctx = tb.getContext();
			if (id == com.immrhy.learningandroidapptool.utils.R.id.tool_bar_back_button) {
