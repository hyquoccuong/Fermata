...
import com.immrhy.learningandroidapptool.utils.function.ShortConsumer;
...
import com.immrhy.learningandroidapptool.utils.pref.PreferenceView.BooleanOpts;
import com.immrhy.learningandroidapptool.utils.pref.PreferenceView.ListOpts;
	...
	public View focusSearch(View focused, int direction) {
		if ((direction == FOCUS_UP) && (focused != null) && (focused.getId() == R.id.equalizer_switch)) {
			View v = MainActivityDelegate.get(getContext()).getToolBar()
					.findViewById(com.immrhy.learningandroidapptool.utils.R.id.tool_bar_back_button);
