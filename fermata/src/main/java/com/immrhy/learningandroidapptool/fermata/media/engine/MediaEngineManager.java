package com.immrhy.learningandroidapptool.fermata.media.engine;

import static com.immrhy.learningandroidapptool.fermata.media.pref.MediaLibPrefs.EXO_ENABLED;
import static com.immrhy.learningandroidapptool.fermata.media.pref.MediaLibPrefs.VLC_ENABLED;
...
import static com.immrhy.learningandroidapptool.fermata.media.pref.MediaPrefs.VIDEO_ENGINE;
...
import com.immrhy.learningandroidapptool.fermata.media.engine.MediaEngine.Listener;
...
public class MediaEngineManager implements PreferenceStore.Listener {
	private static final String EXO_PROV_CLASS =
			"com.immrhy.learningandroidapptool.fermata.engine.exoplayer.ExoPlayerEngineProvider";
	private static final String VLC_PROV_CLASS = "com.immrhy.learningandroidapptool.fermata.engine.vlc.VlcEngineProvider";
