...
import com.immrhy.learningandroidapptool.utils.ui.view.GestureListener;
...
public class ControlPanelView extends ConstraintLayout
	...
	private void setShowHideBarsIcon(MainActivityDelegate a) {
		a.post(() -> showHideBars.setImageResource(
				a.isBarsHidden() ? R.drawable.expand : com.immrhy.learningandroidapptool.utils.R.drawable.collapse));
	}
