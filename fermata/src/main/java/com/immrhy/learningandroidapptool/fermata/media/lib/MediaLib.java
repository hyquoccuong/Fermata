...
import static com.immrhy.learningandroidapptool.fermata.media.pref.BrowsableItemPrefs.SORT_MASK_ALL;
import static com.immrhy.learningandroidapptool.fermata.media.pref.BrowsableItemPrefs.SORT_MASK_NAME_RND;
import static com.immrhy.learningandroidapptool.fermata.util.Utils.getResourceUri;
...
import com.immrhy.learningandroidapptool.fermata.media.engine.MetadataRetriever;
...
import com.immrhy.learningandroidapptool.fermata.media.pref.StreamItemPrefs;
...
import com.immrhy.learningandroidapptool.utils.function.Predicate;
...
public interface MediaLib {
	...
	interface StreamItem extends PlayableItem, BrowsableItem {
		String STREAM_START_TIME = "com.immrhy.learningandroidapptool.media.stream.START_TIME";
		String STREAM_END_TIME = "com.immrhy.learningandroidapptool.media.stream.END_TIME";
	...
	interface BrowsableItem extends Item {
		...
		@Override
		default int getIcon() {
			return com.immrhy.learningandroidapptool.utils.R.drawable.folder;
		}
