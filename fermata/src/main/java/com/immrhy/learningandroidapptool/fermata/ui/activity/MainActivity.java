...
import static com.immrhy.learningandroidapptool.fermata.util.Utils.createDownloader;
...
import static com.immrhy.learningandroidapptool.utils.misc.MiscUtils.isPackageInstalled;
import static com.immrhy.learningandroidapptool.utils.pref.PreferenceStore.Pref.sa;
...
import com.immrhy.learningandroidapptool.utils.net.http.HttpConnection;
...
import com.immrhy.learningandroidapptool.utils.ui.activity.SplitCompatActivityBase;
...
public class MainActivity extends SplitCompatActivityBase
	...
	public FutureSupplier<?> uninstallControl() {
		...
		var pkgName = "com.immrhy.learningandroidapptool.fermata.auto.control.dear.google.why";
