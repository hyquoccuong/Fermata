package com.immrhy.learningandroidapptool.utils.ui;
...
public class UiUtils {
	...
	public static FutureSupplier<PreferenceStore> queryPrefs(
		...
		if (!(a.showFragment(
				com.immrhy.learningandroidapptool.utils.R.id.generic_dialog_fragment) instanceof GenericDialogFragment f))
