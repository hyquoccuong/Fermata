package com.immrhy.learningandroidapptool.fermata.addon.felex.view;

import static android.view.ViewGroup.LayoutParams.MATCH_PARENT;
import static android.view.ViewGroup.LayoutParams.WRAP_CONTENT;
import static androidx.appcompat.content.res.AppCompatResources.getDrawable;
import static java.util.Objects.requireNonNull;
import static com.immrhy.learningandroidapptool.fermata.addon.felex.dict.Dict.findWord;
...
import static com.immrhy.learningandroidapptool.utils.ui.UiUtils.showQuestion;
import static com.immrhy.learningandroidapptool.utils.ui.UiUtils.toIntPx;
import static com.immrhy.learningandroidapptool.utils.ui.UiUtils.toPx;
...
import com.immrhy.learningandroidapptool.fermata.addon.felex.FelexAddon;
import com.immrhy.learningandroidapptool.fermata.addon.felex.R;
import com.immrhy.learningandroidapptool.fermata.addon.felex.dict.Dict;
import com.immrhy.learningandroidapptool.fermata.addon.felex.dict.DictMgr;
import com.immrhy.learningandroidapptool.fermata.addon.felex.dict.Example;
import com.immrhy.learningandroidapptool.fermata.addon.felex.dict.Translation;
import com.immrhy.learningandroidapptool.fermata.addon.felex.dict.Word;
import com.immrhy.learningandroidapptool.fermata.provider.FermataContentProvider;
...
import com.immrhy.learningandroidapptool.utils.ui.view.ScalableTextView;
...
public class FelexListView extends RecyclerView implements Closeable,
	...
	private final class DictAdapter extends Adapter<Holder>
			...
			activity.getContextMenu().show(b -> {
				...
				if (!(item instanceof Example) && !(item instanceof DictMgr)) {
					b.addItem(com.immrhy.learningandroidapptool.fermata.R.id.edit, com.immrhy.learningandroidapptool.fermata.R.drawable.edit,
							com.immrhy.learningandroidapptool.fermata.R.string.edit).setData(dv);
				}
				b.addItem(com.immrhy.learningandroidapptool.fermata.R.id.delete, com.immrhy.learningandroidapptool.fermata.R.drawable.delete,
						com.immrhy.learningandroidapptool.fermata.R.string.delete).setData(dv);

				if (item instanceof Dict) {
					b.addItem(com.immrhy.learningandroidapptool.fermata.R.id.share, com.immrhy.learningandroidapptool.fermata.R.drawable.share,
							com.immrhy.learningandroidapptool.fermata.R.string.share).setData(dv);
		...
		private boolean menuHandler(OverlayMenuItem i) {
			...
			if (id == com.immrhy.learningandroidapptool.fermata.R.id.edit) {
				...
				UiUtils.queryText(getContext(), com.immrhy.learningandroidapptool.fermata.R.string.edit,
						com.immrhy.learningandroidapptool.fermata.R.drawable.edit, oldValue).then(newValue -> {
				...
				String title = ctx.getString(com.immrhy.learningandroidapptool.fermata.R.string.delete);
				String msg = ctx.getString(com.immrhy.learningandroidapptool.fermata.R.string.delete_confirm, item.toString());
				Drawable icon = getDrawable(ctx, com.immrhy.learningandroidapptool.fermata.R.drawable.delete);
			...
			} else if (id == com.immrhy.learningandroidapptool.fermata.R.id.share) {
				Dict d = (Dict) dv.item;
	...
	private final class MgrContent extends Content<DictMgr, Object, MgrContent> {
		...
		CharSequence title() {
			...
			return name.isEmpty() ? getContext().getString(com.immrhy.learningandroidapptool.fermata.R.string.addon_name_felex) :
					name;
		}
	...
	private final class DictItemView extends ConstraintLayout {
		...
		DictItemView(@NonNull Context ctx) {
			...
			setBackgroundResource(com.immrhy.learningandroidapptool.fermata.R.drawable.media_item_bg);
