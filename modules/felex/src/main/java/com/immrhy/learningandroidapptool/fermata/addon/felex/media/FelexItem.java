package com.immrhy.learningandroidapptool.fermata.addon.felex.media;
...
import com.immrhy.learningandroidapptool.fermata.media.lib.BrowsableItemBase;
import com.immrhy.learningandroidapptool.fermata.media.lib.DefaultMediaLib;
import com.immrhy.learningandroidapptool.fermata.media.lib.ItemContainer;
import com.immrhy.learningandroidapptool.fermata.media.lib.MediaLib;
import com.immrhy.learningandroidapptool.fermata.media.lib.PlayableItemBase;
...
public interface FelexItem extends MediaLib.Item {
	...
	class Root extends ItemContainer<FelexItem> implements FelexItem {
		...
		public String getName() {
			return getLib().getContext().getString(com.immrhy.learningandroidapptool.fermata.R.string.addon_name_felex);
		}
	...
	class Dict extends BrowsableItemBase implements FelexItem {
		private final com.immrhy.learningandroidapptool.fermata.addon.felex.dict.Dict dict;

		public Dict(DefaultMediaLib lib, com.immrhy.learningandroidapptool.fermata.addon.felex.dict.Dict dict) {
		...
		public com.immrhy.learningandroidapptool.fermata.addon.felex.dict.Dict getDict() {
			return dict;
		}
	...
	class Tutor extends PlayableItemBase implements FelexItem {
		...
		public static Tutor create(DefaultMediaLib lib, com.immrhy.learningandroidapptool.fermata.addon.felex.dict.Dict dict,
															 DictTutor.Mode mode) {
