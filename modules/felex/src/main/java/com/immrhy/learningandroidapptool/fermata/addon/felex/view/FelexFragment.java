...
import static com.immrhy.learningandroidapptool.fermata.addon.felex.FelexAddon.CACHE_FOLDER;
import static com.immrhy.learningandroidapptool.fermata.addon.felex.FelexAddon.DICT_FOLDER;
...
import static com.immrhy.learningandroidapptool.utils.collection.CollectionUtils.comparing;
import static com.immrhy.learningandroidapptool.utils.collection.CollectionUtils.contains;
import static com.immrhy.learningandroidapptool.utils.text.TextUtils.isNullOrBlank;
import static com.immrhy.learningandroidapptool.utils.ui.UiUtils.queryPrefs;
import static com.immrhy.learningandroidapptool.utils.ui.UiUtils.queryText;
...
import com.immrhy.learningandroidapptool.fermata.addon.felex.tutor.DictTutor;
...
import com.immrhy.learningandroidapptool.utils.voice.TextToSpeech;
...
public class FelexFragment extends MainActivityFragment
	...
	public void contributeToNavBarMenu(OverlayMenu.Builder builder) {
		...
		b.addItem(R.id.start_tutor, com.immrhy.learningandroidapptool.fermata.R.drawable.record_voice, R.string.start_tutor)
				.setSubmenu(this::buildTutorMenu);

		Object content = view().getContent();

		if ((content instanceof DictMgr) || (content instanceof Dict)) {
			b.addItem(com.immrhy.learningandroidapptool.fermata.R.id.refresh, com.immrhy.learningandroidapptool.fermata.R.drawable.refresh,
					com.immrhy.learningandroidapptool.fermata.R.string.refresh).setData(content);
		}
	...
	private boolean navBarMenuItemSelected(OverlayMenuItem item) {
		...
		} else if (id == com.immrhy.learningandroidapptool.fermata.R.id.refresh) {
	...
	private static final class ToolBarMediator implements ToolBarView.Mediator.BackTitleFilter {
		...
		public void enable(ToolBarView tb, ActivityFragment f) {
			...
			addButton(tb, com.immrhy.learningandroidapptool.fermata.R.drawable.playlist_add, ToolBarMediator::add, R.id.add);
			addButton(tb, com.immrhy.learningandroidapptool.fermata.R.drawable.record_voice, ToolBarMediator::tutor,
					R.id.start_tutor);
