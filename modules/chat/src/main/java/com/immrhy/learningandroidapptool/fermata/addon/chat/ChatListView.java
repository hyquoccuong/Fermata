...
public class ChatListView extends RecyclerView {
	...
	public ChatListView(@NonNull Context ctx) {
		...
		assistantIcon = requireNonNull(ContextCompat.getDrawable(ctx, com.immrhy.learningandroidapptool.fermata.R.drawable.chat));
	...
	class ChatListAdapter extends Adapter<Holder> {
		...
		public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
			var v = LayoutInflater.from(getContext())
					.inflate(com.immrhy.learningandroidapptool.fermata.R.layout.list_item, parent, false);
			return new Holder(v);
		}
