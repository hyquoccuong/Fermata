package com.immrhy.learningandroidapptool.fermata.vfs.smb;
...
import com.immrhy.learningandroidapptool.utils.vfs.smb.SmbFileSystem;
...
public class Provider extends VfsProviderBase {
	...
	protected FutureSupplier<? extends VirtualFolder> addFolder(MainActivityDelegate a, VirtualFileSystem fs) {
		...
		prefs.addStringPref(o -> {
			o.store = ps;
			o.pref = SHARE;
			o.title = com.immrhy.learningandroidapptool.fermata.R.string.share_name;
			o.stringHint = "share";
		});
		prefs.addStringPref(o -> {
			o.store = ps;
			o.pref = DOMAIN;
			o.title = com.immrhy.learningandroidapptool.fermata.R.string.domain;
