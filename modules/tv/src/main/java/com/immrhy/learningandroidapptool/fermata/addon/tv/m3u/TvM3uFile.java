...
import static com.immrhy.learningandroidapptool.utils.net.http.HttpFileDownloader.CHARSET;
import static com.immrhy.learningandroidapptool.utils.net.http.HttpFileDownloader.ENCODING;
import static com.immrhy.learningandroidapptool.utils.net.http.HttpFileDownloader.ETAG;
import static com.immrhy.learningandroidapptool.utils.net.http.HttpFileDownloader.MAX_AGE;
import static com.immrhy.learningandroidapptool.utils.net.http.HttpFileDownloader.RESP_TIMEOUT;
import static com.immrhy.learningandroidapptool.utils.net.http.HttpFileDownloader.TIMESTAMP;
import static com.immrhy.learningandroidapptool.utils.text.TextUtils.trim;
...
import com.immrhy.learningandroidapptool.fermata.vfs.m3u.M3uFile;
...
import com.immrhy.learningandroidapptool.utils.db.SQLite;
...
import com.immrhy.learningandroidapptool.utils.net.http.HttpFileDownloader;
import com.immrhy.learningandroidapptool.utils.net.http.HttpFileDownloader.Status;
...
import com.immrhy.learningandroidapptool.utils.ui.notif.HttpDownloadStatusListener;
...
public class TvM3uFile extends M3uFile {
	...
	public FutureSupplier<Status> downloadEpg() {
		...
		l.setSmallIcon(com.immrhy.learningandroidapptool.fermata.R.drawable.notification);
		l.setTitle(ctx.getResources().getString(com.immrhy.learningandroidapptool.fermata.R.string.downloading, url));
		l.setFailureTitle(s -> ctx.getResources().getString(com.immrhy.learningandroidapptool.fermata.R.string.err_failed_to_download, url));
