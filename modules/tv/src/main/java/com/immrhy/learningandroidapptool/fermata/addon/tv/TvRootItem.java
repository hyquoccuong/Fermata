...
import com.immrhy.learningandroidapptool.fermata.addon.tv.m3u.TvM3uEpgItem;
...
import com.immrhy.learningandroidapptool.fermata.addon.tv.m3u.TvM3uGroupItem;
import com.immrhy.learningandroidapptool.fermata.addon.tv.m3u.TvM3uItem;
import com.immrhy.learningandroidapptool.fermata.addon.tv.m3u.TvM3uTrackItem;
...
import static com.immrhy.learningandroidapptool.utils.async.Async.forEach;
...
public class TvRootItem extends ItemContainer<TvM3uItem> implements TvItem {
	...
	protected FutureSupplier<String> buildTitle() {
		return completed(getLib().getContext().getString(com.immrhy.learningandroidapptool.fermata.R.string.addon_name_tv));
	}
