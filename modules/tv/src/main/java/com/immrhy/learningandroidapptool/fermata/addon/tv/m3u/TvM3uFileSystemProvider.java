...
import static com.immrhy.learningandroidapptool.fermata.addon.tv.m3u.TvM3uFile.CATCHUP_DAYS;
import static com.immrhy.learningandroidapptool.fermata.addon.tv.m3u.TvM3uFile.CATCHUP_QUERY;
import static com.immrhy.learningandroidapptool.fermata.addon.tv.m3u.TvM3uFile.CATCHUP_TYPE;
...
import static com.immrhy.learningandroidapptool.fermata.addon.tv.m3u.TvM3uFile.EPG_FILE_AGE;
import static com.immrhy.learningandroidapptool.fermata.addon.tv.m3u.TvM3uFile.EPG_SHIFT;
import static com.immrhy.learningandroidapptool.fermata.addon.tv.m3u.TvM3uFile.EPG_URL;
import static com.immrhy.learningandroidapptool.fermata.addon.tv.m3u.TvM3uFile.LOGO_PREFER_EPG;
import static com.immrhy.learningandroidapptool.fermata.addon.tv.m3u.TvM3uFile.LOGO_URL;
...
public class TvM3uFileSystemProvider extends M3uFileSystemProvider {
	...
	private FutureSupplier<Boolean> requestPrefs(MainActivityDelegate a, PreferenceStore ps) {
		...
		prefs.addStringPref(o -> {
			o.store = ps;
			o.pref = NAME;
			o.title = com.immrhy.learningandroidapptool.fermata.R.string.m3u_playlist_name;
		});
		prefs.addFilePref(o -> {
			o.store = ps;
			o.pref = URL;
		...
		sub.addStringPref(o -> {
			o.store = ps;
			o.pref = AGENT;
			o.title = com.immrhy.learningandroidapptool.fermata.R.string.m3u_playlist_agent;
			o.stringHint = "Fermata/" + BuildConfig.VERSION_NAME;
		});
		sub.addIntPref(o -> {
			o.store = ps;
			o.pref = RESP_TIMEOUT;
			o.title = com.immrhy.learningandroidapptool.fermata.R.string.m3u_playlist_timeout;
		});
